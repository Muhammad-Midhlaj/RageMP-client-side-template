...
LiquidSlider.addArrows = function(arrowClass) {
  ...
  // Build the arrows
  (_this.$sliderWrap).find('.ls-nav ul').before('<div class="ls-nav-left' + arrow + (arrowClass || '') +
    '"><a href="#">' +
    _this.options.dynamicArrowLeftText + '</a></div>');
  (_this.$sliderWrap).find('.ls-nav ul').after('<div class="ls-nav-right' + arrow + (arrowClass || '') +
    '"><a href="#">' +
